...
import { Header, Drawer, Content, Navigation, Layout, Textfield} from 'react-mdl'
import '../Nav/Nav.css';
...
export const Nav = (props) => (
            ...
            <div style={{ height: '350px', position: 'relative' }}>
                <Layout style={{ background: 'url(https://images.unsplash.com/photo-1499551660540-eaf0697882f5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2551&q=80) center / cover' }}>
            ...
            />
                        <Navigation >
                            <Link className="a" to="/login">Games</Link>
                            <Link  to="/">Make Friends!</Link>
                            <Link  to="/">Profile</Link>
                        </Navigation>
                    </Header>
                    <Drawer title="Join Us!">
                        <Navigation>{ !props.isLogin  ?
                    ...
                    :<Button as={Link} to="/" variant="outline-light"> Logout </Button>}
                        </Navigation>
                    </Drawer>
                    <Content />
                </Layout>
